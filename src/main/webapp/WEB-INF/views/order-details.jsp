                ...
                <c:forEach items="${items }" var="item">
	                <div class="border-bottom pb-3">
	                    ...
	                    <div class="p-2">
	                        ...
	                        <h6>Name : ${item.product.company }</h6>
	                        <h6>Address: ${item.product.salt }</h6>
	                        <h6>&#8377; ${item.price}</h6>
        ...
        <div class="col-sm-5">
            <div class='rounded bg-white p-2'>
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>Tax @2%</th>
                        <th class="text-right font-weight-bold">&#8377; ${o.totalOrderPrice * 0.05}</th>
                    </tr>
                    <tr>
                        <th>Net Amount</th>
                        <th class="text-right font-weight-bold">&#8377; ${o.totalOrderPrice+o.totalOrderPrice * 0.05}</th>
                    </tr>
                </table>
            </div>
        </div>
